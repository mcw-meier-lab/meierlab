...
def setup_test_credentials(env_file: Optional[str] = None) -> Dict[str, str]:
    """
...
def create_test_config_with_env(template_type: str = 'xnat', 
...
def get_xnat_test_config(use_env: bool = True, env_file: Optional[str] = None) -> str:
    """
...
def get_custom_xnat_test_config(use_env: bool = True, env_file: Optional[str] = None) -> str:
    """
