...
class CustomXNATDownloadTemplate(XNATDownloadTemplate):
    ...
    def _add_arguments(self, parser):
        ...
        parser.add_argument(
            "--preprocess", action="store_true", help="Enable custom preprocessing"
        )
        parser.add_argument(
            "--quality-check", action="store_true", help="Enable quality checks"
        )
        parser.add_argument(
            "--backup", action="store_true", help="Backup original files"
        )
...
class MinimalDownloadTemplate(BaseDownloadTemplate):
    ...
    def _add_arguments(self, parser):
        ...
        parser.add_argument("--source", help="Source URL or path", required=True)
        parser.add_argument(
            "--dest",
...
class BatchProcessingTemplate(BaseDownloadTemplate):
    ...
    def _add_arguments(self, parser):
        ...
        parser.add_argument(
            "--batch-config", help="Batch configuration file", required=True
        )
        parser.add_argument(
