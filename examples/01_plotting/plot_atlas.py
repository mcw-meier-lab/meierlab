...
from meierlab.viz import networks

schaefer = datasets.load_updated_schaefer()
atlas_coords = networks.get_atlas_coords(schaefer.atlas)
...
# --------------------------
full_connectome = networks.plot_connectome_from_graph(G,atlas_coords)
full_connectome
...
vis = networks.plot_subgraph_connectome(vis_graph[0],atlas_coords)
vis
...
vis_nodes = networks.plot_subgraph_nodes(vis_graph[0],atlas_coords)
